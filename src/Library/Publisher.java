...
public class Publisher extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String phone=txtphone.getText();
        ...
        try {
            pst=con.prepareStatement("insert into publisher1(Name,Address,Phone)values(?,?,?)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            pst=con.prepareStatement("update publisher1 set Name=?,Address=?,Phone=? where id=?");
            pst.setString(1,name);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pst=con.prepareStatement("delete from publisher1 where id=?");
